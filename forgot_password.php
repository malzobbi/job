...
<?php endif; ?>
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><?php if($type=="user"){echo "User Email";}else{echo "company email";} ?></p>
    ...
    <form method="post" action="f_password.php">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="hidden" class="form-control" id="tp" name="tp" value="<?php if($type=="user"){echo "user";}else{echo "company";} ?>">

        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="row">
        <!-- /.col -->
        <div class="form-group has-feedback"><p>If your email is registered in our database, then we will send you an email with a temporary password</p>
          <button type="submit" class="btn btn-primary btn-block btn-flat">Send me Email</button>
        </div>
      </div>
    </form>
