...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_company, jobtitle, description, location, subtitle, experience, qualification) VALUES (?,?, ?, ?, ?, ?, ?)");
	...
	$joblink = mysqli_real_escape_string($conn, $_POST['apply_link']);
	...
	//Insert Job Post Query 
	 $sql = "INSERT INTO job_post(id_company, jobtitle, description, location, subtitle, experience, qualification,apply_link) VALUES ('$_SESSION[id_company]','$jobtitle', '$description', '$location', '$subtitle', '$experience', '$qualification','$joblink')";
