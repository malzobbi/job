              ...
              <form method="post" action="addpost.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <select id="location" name="location" class="form-control" required>
                    <option value="Others">-- Select State / Territory --</option>
                ...
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  ...
                  <?php
                        $skillsResult = $conn->query("SELECT id, skill_name FROM skills ORDER BY skill_name ASC");
                    ?>

                <div class="form-group">
                  <label for="skill">
                    Required Skill <i class="fa fa-cogs"></i>
                  </label>
                
                  <select class="form-control input-lg" id="skill" name="skill" required>
