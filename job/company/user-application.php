               ...
               $sql = "SELECT * FROM users WHERE id_user='$_GET[id]'";
                ...
                <div>
                  <?php
                    ...
                    echo '<br>';
                    if($row['resume'] != "") {
                      echo '<a href="../user/resume/'.$row['resume'].'" class="btn btn-info" download="Resume">Download Resume</a>';
                    }
                    echo '<br>';
                    echo '<br>';
                    echo '<br>';
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 pull-centre">
                      <a href="approved.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>" class="btn btn-primary">Mark Approved</a>
                    </div>
