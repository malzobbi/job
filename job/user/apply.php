...
if(isset($_POST)) {
	...
	$sql = "SELECT * FROM job_post WHERE id_jobpost='$_POST[job_id]'";
    ...
    if($result1->num_rows == 0) {  
    	...
    	$sql = "INSERT INTO apply_job_post(id_jobpost, id_company, id_user) VALUES ('$_POST[job_id]', '$id_company', '$_SESSION[id_user]')";
