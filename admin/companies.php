            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="allusers.php"><i class="fa fa-user"></i> Users</a></li>
                  ...
                  <?php if(isset($_SESSION['reset_msg'])): ?>
                    <div class="alert alert-success">
                      <?php 
                        ...
                        unset($_SESSION['reset_msg']); // clear after showing
                      ?>
                    </div>
                  <?php endif; ?>
...
<!-- RESET PASSWORD -->
<td>
  <a href="reset.php?id=<?php echo (int)$row['id_company']; ?>"
     class="btn btn-warning btn-xs"
     onclick="return confirm('Reset password for this company?');">
...
<td>
  <?php if($row['active'] == 1): ?>
    <a href="toggle_company.php?id=<?php echo (int)$row['id_company']; ?>"
...
<!-- DELETE -->
<td>
  <a href="delete-company.php?id=<?php echo (int)$row['id_company']; ?>"
     class="btn btn-danger btn-xs"
