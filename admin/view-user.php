        ...
        <div class="col-md-3">
          <div class="thumbnail">
            ...
            <div class="caption text-center">
                ...
                <?php if($row['gender']==1){echo "Male";}else if ($row['gender']==2){echo "Female";}else{echo "Others";}; ?>
