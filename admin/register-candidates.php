          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1960-01-01" max="2020-01-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
              ...
              if(isset($_SESSION['registerError'])) {
                ?>
                <div class="form-group">Possible Errors:<br>
                  <label style="color: red;">Email Already Exists! Choose A Different Email!</label>
                  <label style="color: red;">Password is not complex. It has to be min. 8 Characters </label>
                </div>
              <?php
